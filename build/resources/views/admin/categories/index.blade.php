...
@section('title', 'Manage Categories | ELM GROVE LIQUOR')
                    ...
                    <tbody class="divide-y divide-white/5 text-gray-300">
                        @foreach($categories as $category)
                            <tr class="hover:bg-white/5 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    @if($category->image)
                                        <img src="{{ Storage::url($category->image) }}" alt="{{ $category->name }}" class="w-12 h-12 object-cover rounded-sm border border-white/10">
                                    @else
                                        <div class="w-12 h-12 bg-black-900 flex items-center justify-center rounded-sm border border-white/10">
