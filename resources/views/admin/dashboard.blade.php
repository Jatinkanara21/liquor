...
@section('title', 'Admin Dashboard | Elite Liquor House')
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="glass p-6 rounded-sm border-l-4 border-purple-500">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <p class="text-gray-400 text-sm uppercase tracking-wider">Active Customers</p>
                        <h3 class="text-3xl font-bold text-white mt-1">{{ \App\Models\User::count() }}</h3>
                    </div>
