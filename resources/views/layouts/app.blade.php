...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Elite Liquor House - Premium Spirits, Fine Wines, and Exclusive Collections. Experience luxury in every sip.')">
    <meta name="keywords" content="premium liquor, rare whiskey, fine wine, champagne, luxury alcohol, elite liquor">
    <title>@yield('title', 'Elite Liquor House | Premium Spirits')</title>
    ...
    <footer class="bg-black-950 border-t border-gold-500/20 pt-16 pb-8">
        <div class="container mx-auto px-6">
            ...
            <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-500 text-sm">&copy; {{ date('Y') }} Elite Liquor House. All rights reserved.</p>
